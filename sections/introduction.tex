...
Similar to a tool like Microsoft Word, \latex is a tool used to process documents. However, \latex does this in a programmatical manner, likening it to a programming language, whereas Microsoft Word has a that


- xetex
    - came after pdflatex but before lualatex created for better font handling
    - specify not under consideration
        - since latex devs focused on lualatex
    - was useful, but not used much
    - 'could be considered evolutionary deadend'/might become one/find authorative source to say it is
